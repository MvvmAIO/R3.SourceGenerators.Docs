...
本 **VitePress** 站点是 **MvvmAIO.R3.SourceGenerators** 的结构化手册。
...
使用 **VitePress** + **Node.js**，与 [Prism.SourceGenerators.Docs](https://mvvmaio.github.io/Prism.SourceGenerators.Docs/)（NuStreamDocs + .NET）刻意区分，便于对比文档体验。
...
当生成器行为或 **R3SG** 诊断变更时，请同步更新**两种语言**下的对应页面。
